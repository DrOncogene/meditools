...
>
  <div class="flex flex-col space-y-6">
    ...
    <button on:click={openDrawer} class="btn bg-primary-500 rounded-md text-white w-min md:hidden"
      >Get started</button
    >
    <button
      on:click={openSideBar}
      class="btn bg-primary-500 rounded-md text-white w-min max-md:hidden">Get started</button
    >
  </div>
