...
> -->
<div class="flex flex-col space-y-6 p-8 md:p-16 self-center">
  ...
  <button
    ...
    class="btn bg-primary-500 rounded-md text-white w-min max-xl:hidden">Get started</button
  >
</div>
<div class="w-[500px] h-[400px] grid place-items-center p-8 md:p-16 self-center">
  <img src={Hero} alt="" />
</div>
