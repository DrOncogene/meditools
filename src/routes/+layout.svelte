...
>
	...
	<main class="flex justify-center relative overflow-hidden max-h-[calc(100vh_-_80px)]">
		...
		<Sidebar />
		<section
			class="grid auto-rows- md:grid-cols-[1.5fr_1fr] w-full h-full ml-8 lg:ml-[350px] transition-[margin-left] duration-200 border-t-2 border-surface-600 overflow-auto"
		>
			<slot />
		</section>
	</main>
